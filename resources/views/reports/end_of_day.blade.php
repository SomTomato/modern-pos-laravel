...
<div class="card">
    <div class="card-header no-print" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <a href="{{ route('reports.end_of_day.print', ['report_date' => $reportDate]) }}" class="btn btn-primary" target="_blank">
            <i class="fa-solid fa-print"></i> Print Report
        </a>
    </div>

    <div class="card-body">
        <div class="no-print" style="padding-bottom: 20px; border-bottom: 1px solid #dee2e6; margin-bottom: 20px;">
        ...
        {{-- THE FIX: Removed hardcoded background-color and used a theme-aware class --}}
        ...
        <div class="card" style="margin-top: 30px;">
            <div class="card-header">
                <h3>All Transactions for {{ \Carbon\Carbon::parse($reportDate)->format('F j, Y') }}</h3>
            </div>
            <table class="styled-table">
                <thead>
                    <tr>
